...
/**
 * Define a Zax that walks southward
 */

public class SouthGoingZax extends Zax {

    /**
     * Create a Zax that walks southward
     */
    public SouthGoingZax(int x, int y, JPanel panel)
    {
        // Call the constructor of the superclass
    }

    /**
     * Draw a south going zax (complete)
     */
     ...
     * for a south going zax (complete)
     */
    private void drawEye(Graphics g, int x, int y)
    {
        ...
        g.fillOval(x-(this.EYE_WIDTH-this.IRIS_SIZE)/2,
                   y+this.EYE_HEIGHT/2-3*this.IRIS_SIZE/2,
                   this.IRIS_SIZE,this.IRIS_SIZE);
    }

    /**
     * Move this Zax to the south
     */
