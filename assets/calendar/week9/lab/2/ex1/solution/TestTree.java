...
public class TestTree {
    ...
    public static void main(String[] args)
    {
        ...
        // Create a tree of height H-1 that contains 1,2,...,2^H-1
        int H=5;
        for(int h=0; h<H; ++h)
        {
    ...
    private static void command(String choice, BSTree t, BufferedReader in)
    {
        int val;
        ...
        else if (choice.startsWith("BF"))
        {
            ...
            t.printBreadthFirst(System.out);
            System.out.println();
        }
        else if (choice.startsWith("I"))
        {
            // Insert an item in the tree
            val = Integer.parseInt(choice.substring(1).trim());
            t.insert(val);
        }
    ...
    private static void commandList()
    {
        ...
        output += "BF       : to print the tree breadth first\n";
